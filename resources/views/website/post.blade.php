          ...
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              ...
              <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="@if ($post->user->image) {{ asset($post->user->image) }} @else {{ asset('website/images/user.png') }} @endif" alt="Image" class="img-fluid"></figure>
          ...
          <div class="col-md-12 col-lg-8 main-content">           
            <div class="post-content-body">
              ...
              <div style="text-align:center;">
                <img style="max-width:400px;" src="{{ $post->image }}" alt="">
              </div>
              {!! $post->description !!}
            </div>           
            <div class="pt-5">
              <p>Categories:  <a href="#">{{ $post->category->name }}</a>, <a href="#">Travel</a>  
            ...
            <div class="sidebar-box">
              ...
              <div class="post-entry-sidebar">
                <ul>
                  ...
                  <li>
                    <a href="">
                      <img src="{{ $pp->image }}" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>{{ $pp->title }}</h4>
                        <div class="post-meta">
                          <span class="mr-2">{{ $pp->created_at->format('M d, Y') }}</span>
                        </div>
                      </div>
                    </a>
                  </li>
...
<script>
    ...
    s.src = 'https://tutorial-16.disqus.com/embed.js';
